<%@ Page Title="" Language="C#" MasterPageFile="~/master-pages/main.Master" AutoEventWireup="true" CodeFile="questions.aspx.cs" Inherits="Psychometric.master_pages.WebForm2x" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid p-0" dir="rtl" lang="he">
        ...
        <h1 class="h3 mb-3" runat="server" id="TitlePage">תרגול מילים באנגלית</h1>
                    ...
                    <div class="card-body">
                        ...
                        <div id="questionDiv" class="displayNone">
                            ...
                            <h1>איזו מילה פירושה:
                                ...
                                <span><strong id="questionText"></strong>?</span></h1>
                            <br />
                            <br />
                            <br />
                            <div class="row">
...
<asp:Content ID="Content3" ContentPlaceHolderID="JsHolder" runat="server">
    <script src="../js-english/questions.js?2"></script>
</asp:Content>
