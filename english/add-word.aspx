<%@ Page Title="" Language="C#" MasterPageFile="~/master-pages/main.Master" AutoEventWireup="true" CodeFile="add-word.aspx.cs" Inherits="Psychometric.master_pages.WebForm6x" %>
    ...
    <asp:UpdatePanel ID="WordAddingPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <ContentTemplate>
            <div class="container-fluid p-0" dir="rtl" lang="he">
                <h1 class="h3 mb-3">הוספת מילה למילון באנגלית</h1>
                                                ...
                                                <div class="words-scroll">
                                                    <table class="table table-striped table-sm" dir="ltr">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="table-action">
                                                                    <a href="../english/edit-word.aspx?Id=<%=row[0] %>" class="editWord"><i class="far fa-edit"></i></a>
                                                                </td>
                                                                <td><%=row[2] %></td>
                                                            </tr>
                                                            <%
...
<asp:Content ID="Content3" ContentPlaceHolderID="JsHolder" runat="server">
    <script src="../js-english/add-word.js?2"></script>
</asp:Content>
