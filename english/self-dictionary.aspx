<%@ Page Title="" Language="C#" MasterPageFile="~/master-pages/main.Master" AutoEventWireup="true" CodeFile="self-dictionary.aspx.cs" Inherits="Psychometric.master_pages.WebForm4x" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-fluid p-0" dir="rtl" lang="he">
        ...
        <h1 class="h3 mb-3">מילון אישי</h1>
        ...
        <div class="row">
            <div class="col-md-12 col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="buttonLinks" href="../english/add-word.aspx">
                            <div class="col-md-12 col-xl-12 text-center">
                                <div class="card py-2 py-md-1 border">
                                    <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="col-md-12 col-xl-12 text-center">
                            <%
                                ...
                                {
                            %>
                            <a class="buttonLinks" href="../english/words-content.aspx?category=<%=row[0] %>">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-md-12 col-xl-12">
                            <a class="buttonLinks" href="../english/words-content.aspx?type=4">
                                <div class="card py-2 py-md-1 border">
                                    <div class="card-body text-center">
                        ...
                        <div class="col-md-12 col-xl-12">
                            <a class="buttonLinks" href="../english/words-content.aspx?type=3">
                                <div class="card py-2 py-md-1 border">
                                    <div class="card-body text-center">
                        ...
                        <div class="col-md-12 col-xl-12">
                            <a class="buttonLinks" href="../english/words-content.aspx?type=2">
                                <div class="card py-2 py-md-1 border">
                                    <div class="card-body text-center">
                        ...
                        <div class="col-md-12 col-xl-12">
                            <a class="buttonLinks" href="../english/words-content.aspx?type=1">
                                <div class="card py-2 py-md-1 border">
                                    <div class="card-body text-center">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="col-md-12 col-xl-12">
                            <a class="buttonLinks" href="../english/words-content.aspx?type=5">
                                <div class="card py-2 py-md-1 border">
                                    <div class="card-body text-center">
                        ...
                        <div class="col-md-12 col-xl-12">
                            <a class="buttonLinks" href="../english/words-content.aspx?type=6">
                                <div class="card py-2 py-md-1 border">
                                    <div class="card-body text-center">
...
<asp:Content ID="Content3" ContentPlaceHolderID="JsHolder" runat="server">
    <script src="../js-english/deleteCategory.js?2"></script>
</asp:Content>
