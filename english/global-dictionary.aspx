<%@ Page Title="" Language="C#" MasterPageFile="~/master-pages/main.Master" AutoEventWireup="true" CodeFile="global-dictionary.aspx.cs" Inherits="Psychometric.master_pages.WebForm7x" %>
    ...
    <asp:UpdatePanel ID="GlobalDictionaryPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
        ...
        <ContentTemplate>
            <div class="container-fluid p-0" dir="rtl" lang="he">
                ...
                <h1 class="h3 mb-3">חיפוש באנגלית</h1>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JsHolder" runat="server">
    <script src="../js-english/global-dictionary.js?2"></script>
</asp:Content>
