<%@ Page Title="" Language="C#" MasterPageFile="~/master-pages/main.Master" AutoEventWireup="true" CodeFile="words-content.aspx.cs" Inherits="Psychometric.master_pages.WebForm1" %>
            ...
            <div class="col-md-2 col-xl-2">
                <div class="card">
                    ...
                    <div class="words-content">
                        <div id="wordsOptions" class="list-group list-group-flush words-scroll" role="tablist">
                            <%
...
<asp:Content ID="Content3" ContentPlaceHolderID="JsHolder" runat="server">
    <script src="../js-hebrew/words-content.js?2"></script>
</asp:Content>
