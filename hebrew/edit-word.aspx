<%@ Page Title="" Language="C#" MasterPageFile="~/master-pages/main.Master" AutoEventWireup="true" CodeFile="edit-word.aspx.cs" Inherits="Psychometric.master_pages.EditWord" %>
    ...
    <asp:UpdatePanel ID="WordAddingPanel" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <ContentTemplate>
            <div class="container-fluid p-0" dir="rtl" lang="he">
                <h1 class="h3 mb-3"><span>עריכת מילה בעברית: </span>
                    <strong>
                ...
                <div class="row">
                    <div class="col-12 col-xl-6">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">הוסף\מחק פירושים (סמן מה שתרצה למחוק):</h5>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JsHolder" runat="server">
    <script src="../js-hebrew/edit-word.js?2"></script>
</asp:Content>
